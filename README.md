...
如果你想直接获得开箱即用的体验，无需手动搭建任何 Node 环境，可使用自带前后端的跨平台桌面版，**请直接前往 [Releases 页面](https://github.com/chthollyphile/folia-major/releases) 下载** 最新版本。
...
4. 其他 Linux 发行版：从 Releases 下载 `tar.gz`，解压后直接运行 `folia-major`
   `tar.gz` 内附带图标和 `.desktop` 模板，您可以手动创建桌面启动项。
