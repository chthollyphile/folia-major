...
export default {
  ...
  "home": {
    ...
    "latticeHelp": "操作提示",
    "latticeHelpPoster": "点击海报以聚焦展开",
    "latticeHelpReturn": "返回",
    "latticeHelpMove": "滚轮移动·鼠标拖动·方向键切换",
    "latticeHelpCommands": "打开命令面板以进行操作",
    "latticeHelpOpen": "在其他界面打开队列拼贴",
  ...
  "options": {
    ...
    "liquidGlassTuning": "液态玻璃",
    "liquidGlassEnabled": "启用液态玻璃",
    "liquidGlassTuningReset": "重置",
    "liquidGlassRefraction": "折射强度",
    "liquidGlassBlur": "背景模糊",
    "liquidGlassSaturation": "饱和度",
    "liquidGlassRim": "边缘高光",
    "liquidGlassTint": "底色",
    "liquidGlassDispersion": "边缘色散",
    "liquidGlassDispersionDesc": "开启后会造成较高性能消耗",
    "liquidGlassDispersionStrength": "色散强度",
    "liquidGlassAdvanced": "高级选项",
