...
export default {
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "visualizer-claddagh": { "title": "可视化：指环", "description": "切换到指环可视化" },
  ...
  "options": {
    ...
    "claddaghSettings": "指环参数",
    "claddaghSettingsDesc": "调整歌词大小对比率、椭圆轨道半径及倾斜度。",
    "claddaghFocusScaleRatio": "主歌词放大倍率",
    "claddaghRadiusScale": "椭圆轨道半径",
    "claddaghEllipseTiltDeg": "椭圆轨道倾斜度",
    "customFont": "自定义字体",
    "fontFamily": "字体",
    "fontSize": "字号",
    "fontPreview": "预览",
