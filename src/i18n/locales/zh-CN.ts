...
export default {
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "settings-mobile-ai": { "title": "移动端 AI 设置", "description": "打开移动端 OpenAI 兼容接口设置" },
  ...
  "options": {
    ...
    "mobileAiSettings": "移动端 AI",
    "mobileAiSettingsDesc": "移动端使用的 OpenAI 兼容接口、模型和密钥。",
    "mobileAiGeminiCompatDesc": "Gemini 可以通过它的 OpenAI 兼容接口填写在这里。",
    "mobileAiKeyStored": "已保存",
    "mobileAiClearKey": "清除密钥",
    "mobileAiMissingConfig": "请先填写接口链接、模型和密钥。",
    "mobileAiConnectionSuccess": "连接可用。",
    "saved": "已保存",
    "testConnection": "测试连接",
  ...
  "localMusic": {
    ...
    "importing": "导入中...",
    "noLocalMusic": "暂无本地音乐",
    "mobileImportUnavailable": "移动端暂不支持按文件夹导入本地音乐。",
