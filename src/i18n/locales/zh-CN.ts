...
export default {
  "notifications": {
    ...
    "traditionalLyricsOn": "简体歌词转繁体已开启",
    "traditionalLyricsOff": "已恢复显示原始歌词文本",
  ...
  "status": {
    ...
    "playbackError": "播放出错",
    "spotifyNoSynchronizedLyrics": "未找到 {{title}} 的同步歌词；Folia 已阻止空白歌词动画页面打开。",
    "spotifyControlFailed": "Spotify 控制失败：{{error}}",
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "settings-toggle-traditional-lyrics": { "title": "切换繁体歌词", "description": "在本机将显示的简体歌词转换为繁体" },
  ...
  "options": {
    ...
    "convertSimplifiedLyricsToTraditional": "简体歌词转繁体",
    "convertSimplifiedLyricsToTraditionalDesc": "在本机转换原文、翻译与逐字歌词，不改变时间轴。",
    ...
    "spotifyMirrorDescription": "在 Folia 中同步并控制 Spotify 客户端，同时自动匹配歌词；音频仍由 Spotify 播放。",
    "spotifyClientId": "Spotify Client ID",
    "spotifyClientIdPlaceholder": "粘贴 Spotify 应用的 Client ID",
    "spotifyRedirectUri": "Redirect URI",
    "spotifyRedirectInstruction": "连接前，请先在 Spotify Developer Dashboard 中加入这个完全一致的 URI。",
    "spotifyAuthorizing": "等待授权",
    "spotifyConnected": "已连接",
    "spotifyReconnectRequired": "需要重新连接",
    "spotifyDisconnected": "未连接",
    "spotifyConnect": "连接 Spotify",
    "spotifyReconnect": "重新连接",
    "spotifyReconnectForControls": "请重新连接 Spotify，并批准新的播放控制权限，之后这些按钮才会生效。",
    "spotifyControlsRequirement": "播放控制使用 Spotify Connect，需要 Spotify Premium，并且必须有可用的 Spotify 播放设备。",
    "spotifyDisconnect": "断开连接",
    "spotifyOpenDashboard": "打开 Spotify Dashboard",
    "spotifyWaitingTitle": "等待 Spotify 播放",
    "spotifyConnectionError": "请先在集成设置中连接 Spotify，并保持 Spotify 桌面客户端运行。",
    "spotifyNoPlayback": "请在 Spotify 中开始播放歌曲，Folia 会自动载入歌曲并匹配歌词。",
    "spotifyNoSyncedLyricsTitle": "未找到同步歌词",
    "spotifyNoSyncedLyricsDescription": "Folia 的歌词来源没有返回真实时间轴，因此不会载入这首 Spotify 歌曲。请尝试其他歌曲。",
