...
export default {
  "notifications": {
    ...
    "launchAtLoginOn": "已开启开机自动运行",
    "launchAtLoginOff": "已关闭开机自动运行",
    "autoplayOnLaunchOn": "启动时将自动播放",
    "autoplayOnLaunchOff": "启动时不再自动播放",
    "rememberPlaybackPositionOn": "将记住上一次播放进度",
    "rememberPlaybackPositionOff": "不再记住播放进度",
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "desktop-toggle-close-to-tray": { "title": "关闭到托盘", "description": "切换点击关闭时隐藏到托盘还是退出应用" },
      "desktop-toggle-launch-at-login": { "title": "开机自动运行", "description": "切换登录系统后是否自动启动 Folia" },
      "playback-toggle-autoplay-on-launch": { "title": "启动时自动播放", "description": "切换程序启动后是否自动开始播放" },
      "playback-toggle-remember-position": { "title": "记住播放进度", "description": "切换启动时是否恢复上一次的播放进度" },
      ...
      "playback-loop": { "title": "切换播放模式", "description": "在顺序播放、列表循环、单曲循环、随机播放之间切换" },
  ...
  "options": {
    ...
    "desktopTrayBehaviorDesc": "仅桌面端生效。可控制最小化到托盘、关闭到托盘、隐藏任务栏图标，以及启动时是否直接进入播放页。",
    "minimizeToTray": "最小化到托盘",
    "minimizeToTrayDesc": "点击最小化时，应用将隐藏至系统托盘。",
    "closeToTray": "关闭到托盘",
    "closeToTrayDesc": "点击关闭按钮时不退出应用，改为隐藏至系统托盘，可从托盘图标重新打开。",
    "launchAtLogin": "开机自动运行",
    "launchAtLoginDesc": "登录系统后自动启动 Folia。可配合“关闭到托盘”使用，让应用常驻托盘。",
    "launchAtLoginUnsupported": "当前系统不支持自动设置开机启动，请手动创建 autostart 启动项。",
    "launchPlaybackSettings": "启动播放行为",
    "autoplayOnLaunch": "程序启动时自动播放",
    "autoplayOnLaunchDesc": "恢复上次会话后立即开始播放。浏览器限制自动播放时会提示需要手动点击。",
    "rememberPlaybackPosition": "程序启动时记住上一次播放进度",
    "rememberPlaybackPositionDesc": "记录当前歌曲的播放位置，下次启动恢复同一首歌时从该位置继续。开头和结尾附近的进度不会记录。",
