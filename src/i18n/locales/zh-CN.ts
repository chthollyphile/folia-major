...
export default {
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "lattice-focus-current": { "title": "聚焦当前歌曲", "description": "将正在播放的歌曲置于歌曲墙中央" },
      "navigate-lattice": { "title": "打开歌曲墙", "description": "以海报墙的形式展示播放队列" },
  ...
  "home": {
    ...
    "latticePosterCount": "{{count}} 张海报",
    "latticePlay": "播放",
    "latticePanel": "歌曲墙面板",
    "latticePanelClose": "关闭歌曲墙面板",
