...
export default {
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "lattice-focus-current": { "title": "聚焦当前歌曲", "description": "将正在播放的歌曲置于播放队列中央" },
      "navigate-lattice": { "title": "打开播放队列", "description": "以海报墙的形式展示播放队列" },
      ...
      "settings-toggle-lattice-vignette": { "title": "切换队列拼贴暗角", "description": "开关队列拼贴页面四周的边缘暗角" },
  ...
  "home": {
    ...
    "latticeClose": "收起海报",
    "latticeExplore": "拖动探索",
    "latticeExploreHint": "滚轮移动 · 方向键切换 · Esc 收起",
