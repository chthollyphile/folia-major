...
export default {
  ...
  "lyricFilter": {
    ...
    "enableFilter": "启用逐行过滤",
    "regexPattern": "正则表达式",
    "regexDescription": "按整首歌的正文歌词逐行匹配，命中后删除整行。可填多行，每行一条独立规则。",
    "inputPlaceholder": "每行一条正则，可填多行",
    "example": "示例：",
  ...
  "lyricStaff": {
    ...
    "customPatternDesc": "留空使用内置署名词表。填写后整体替换内置规则，每行一条独立规则，但仍然只作用于开头那一块。",
    "customPatternPlaceholder": "留空使用内置词表；每行一条正则，可填多行",
    "verdict": "当前歌曲的判定",
    "verdictNone": "未识别到署名块",
    "verdictKeep": "原样显示",
