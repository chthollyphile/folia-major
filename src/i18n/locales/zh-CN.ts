...
export default {
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "background-nomand": { "title": "背景切换到 Nomand", "description": "切换到使用主题色的图像抖动背景" },
  ...
  "options": {
    ...
    "nomandBackgroundSettings": "Nomand 背景",
    "nomandBackgroundSettingsDesc": "使用当前明暗主题配色，对歌曲封面或自定义图片进行抖动着色。",
    "nomandBackgroundSource": "图片来源",
    "nomandBackgroundDitheringType": "抖动图案",
