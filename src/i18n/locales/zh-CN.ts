...
export default {
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "settings-subtitle-translation": { "title": "使用翻译副字幕", "description": "在歌词动画中显示翻译轨道" },
      "settings-subtitle-romanization": { "title": "使用罗马音副字幕", "description": "在歌词动画中显示罗马音轨道" },
      "settings-subtitle-none": { "title": "隐藏副字幕文本", "description": "隐藏翻译与罗马音，但保留下一句提示" },
