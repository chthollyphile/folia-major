...
export default {
  ...
  "lyricFilter": {
    ...
    "regexDescription": "Cocokkan setiap baris teks lirik dengan pola dan hapus baris yang cocok. Boleh beberapa baris, masing-masing aturan tersendiri.",
    "inputPlaceholder": "Satu regex per baris, boleh beberapa baris",
    "example": "Contoh:",
  ...
  "lyricStaff": {
    ...
    "customPatternDesc": "Kosongkan untuk memakai kamus kredit bawaan. Pola kustom menggantikannya, satu aturan per baris, dan tetap hanya berlaku pada blok pembuka.",
    "customPatternPlaceholder": "Kosongkan untuk kamus bawaan; satu regex per baris, boleh beberapa baris",
