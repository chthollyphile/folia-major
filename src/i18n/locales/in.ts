export default {
  "notifications": {
    ...
    "closeToTray": "Menutup jendela akan sembunyi di tray",
    "closeToQuit": "Menutup jendela akan keluar dari aplikasi",
    "launchAtLoginOn": "Jalankan saat login diaktifkan",
    "launchAtLoginOff": "Jalankan saat login dinonaktifkan",
    "autoplayOnLaunchOn": "Pemutaran akan dimulai otomatis saat aplikasi dibuka",
    "autoplayOnLaunchOff": "Pemutaran tidak akan dimulai otomatis saat aplikasi dibuka",
    "rememberPlaybackPositionOn": "Posisi pemutaran terakhir akan diingat",
    "rememberPlaybackPositionOff": "Posisi pemutaran terakhir tidak akan diingat",
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "desktop-toggle-close-to-tray": { "title": "Tutup ke tray", "description": "Alihkan sembunyi ke tray alih-alih keluar saat menutup" },
      "desktop-toggle-launch-at-login": { "title": "Jalankan saat login", "description": "Alihkan menjalankan Folia otomatis setelah Anda masuk" },
      "playback-toggle-autoplay-on-launch": { "title": "Putar otomatis saat dibuka", "description": "Alihkan memulai pemutaran otomatis saat aplikasi dibuka" },
      "playback-toggle-remember-position": { "title": "Ingat posisi pemutaran", "description": "Alihkan melanjutkan posisi pemutaran terakhir saat dibuka" },
      ...
      "playback-loop": { "title": "Alihkan mode putar", "description": "Beralih antara berurutan, ulang semua, ulang satu, dan acak" },
  ...
  "options": {
    ...
    "desktopTrayBehaviorDesc": "Hanya desktop. Kontrol minimalkan-ke-tray, tutup-ke-tray, dan apakah peluncuran langsung membuka halaman pemutar.",
    "minimizeToTray": "Minimalkan ke tray",
    "minimizeToTrayDesc": "Sembunyikan aplikasi ke tray sistem saat Anda mengklik minimalkan.",
    "closeToTray": "Tutup ke tray",
    "closeToTrayDesc": "Sembunyikan aplikasi ke tray sistem alih-alih keluar saat Anda mengklik tombol tutup. Buka kembali dari ikon tray.",
    "launchAtLogin": "Jalankan saat login",
    "launchAtLoginDesc": "Jalankan Folia otomatis setelah Anda masuk ke sistem. Cocok dipadukan dengan tutup-ke-tray agar aplikasi tetap di tray.",
    "launchAtLoginUnsupported": "Platform ini tidak dapat mengatur jalankan saat login secara otomatis. Buat entri autostart secara manual.",
    "launchPlaybackSettings": "Perilaku pemutaran saat dibuka",
    "autoplayOnLaunch": "Putar otomatis saat aplikasi dibuka",
    "autoplayOnLaunchDesc": "Mulai memutar segera setelah sesi sebelumnya dipulihkan. Jika peramban memblokir putar otomatis, Anda akan diminta mengklik sekali.",
    "rememberPlaybackPosition": "Ingat posisi pemutaran terakhir",
    "rememberPlaybackPositionDesc": "Catat posisi lagu saat ini dan lanjutkan dari sana saat aplikasi dibuka lagi dengan lagu yang sama. Posisi di dekat awal atau akhir tidak dicatat.",
