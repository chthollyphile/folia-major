...
export default {
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "settings-mobile-ai": { "title": "Mobile AI settings", "description": "Open mobile OpenAI-compatible settings" },
  ...
  "options": {
    ...
    "mobileAiSettings": "Mobile AI",
    "mobileAiSettingsDesc": "OpenAI-compatible API key, endpoint, and model for mobile.",
    "mobileAiGeminiCompatDesc": "Gemini can be used here through its OpenAI-compatible endpoint.",
    "mobileAiKeyStored": "Stored",
    "mobileAiClearKey": "Clear Key",
    "mobileAiMissingConfig": "Fill API URL, model, and API key first.",
    "mobileAiConnectionSuccess": "Connection works.",
    "saved": "Saved",
  ...
  "localMusic": {
    ...
    "mobileImportUnavailable": "Folder import is not available on mobile yet.",
