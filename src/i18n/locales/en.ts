...
export default {
  ...
  "options": {
    ...
    "labHidePlayerUiDesc": "Only applies on the player page. You can hide the bottom control bar, translation subtitle, and right-side button separately. After hiding the right-side button, you can still use P to open or close the right panel.",
    "hidePlayerProgressBar": "Hide player bottom control bar",
    "hidePlayerTranslationSubtitle": "Hide player translation subtitle",
