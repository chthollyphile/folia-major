...
export default {
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "settings-subtitle-translation": { "title": "Use translation subtitles", "description": "Show the translation track as the visualizer subtitle" },
      "settings-subtitle-romanization": { "title": "Use romanization subtitles", "description": "Show the romanization track as the visualizer subtitle" },
      "settings-subtitle-none": { "title": "Hide subtitle text", "description": "Hide translation and romanization while keeping upcoming-line hints" },
