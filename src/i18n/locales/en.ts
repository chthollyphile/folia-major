...
export default {
  "notifications": {
    ...
    "traditionalLyricsOn": "Simplified lyrics will be shown in Traditional Chinese",
    "traditionalLyricsOff": "Original lyric text will be shown",
  ...
  "status": {
    ...
    "spotifyNoSynchronizedLyrics": "No synchronized lyrics were found for {{title}}. Folia did not open an empty visualizer.",
    "spotifyControlFailed": "Spotify control failed: {{error}}",
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "settings-toggle-traditional-lyrics": { "title": "Toggle Traditional Chinese lyrics", "description": "Convert displayed Simplified Chinese lyrics to Traditional Chinese locally" },
  ...
  "options": {
    ...
    "convertSimplifiedLyricsToTraditional": "Simplified Lyrics to Traditional Chinese",
    "convertSimplifiedLyricsToTraditionalDesc": "Convert original lyrics, translations, and word-synced text locally. Timing remains unchanged.",
    ...
    "spotifyMirrorDescription": "Mirrors and controls the active Spotify client from Folia while automatically matching lyrics. Audio remains in Spotify.",
    "spotifyClientId": "Spotify Client ID",
    "spotifyClientIdPlaceholder": "Paste the Client ID from your Spotify app",
    "spotifyRedirectUri": "Redirect URI",
    "spotifyRedirectInstruction": "Add this exact URI to your app in the Spotify Developer Dashboard before connecting.",
    "spotifyAuthorizing": "Waiting for authorization",
    "spotifyConnected": "Connected",
    "spotifyReconnectRequired": "Reconnect required",
    "spotifyDisconnected": "Not connected",
    "spotifyConnect": "Connect Spotify",
    "spotifyReconnect": "Reconnect",
    "spotifyReconnectForControls": "Reconnect Spotify and approve the new playback-control permission to enable these buttons.",
    "spotifyControlsRequirement": "Playback controls use Spotify Connect and require Spotify Premium. Keep an active Spotify device available.",
    "spotifyDisconnect": "Disconnect",
    "spotifyOpenDashboard": "Open Spotify Dashboard",
    "spotifyWaitingTitle": "Waiting for Spotify",
    "spotifyConnectionError": "Connect Spotify in Integration settings, then keep the Spotify desktop app running.",
    "spotifyNoPlayback": "Start playing a track in Spotify. Folia will load it and match lyrics automatically.",
    "spotifyNoSyncedLyricsTitle": "No synchronized lyrics found",
    "spotifyNoSyncedLyricsDescription": "This Spotify track was not activated because none of Folia's lyric sources returned a real timeline. Try another track.",
