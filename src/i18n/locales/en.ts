...
export default {
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "lattice-focus-current": { "title": "Focus current song", "description": "Center the playing song in the play queue" },
      "navigate-lattice": { "title": "Go play queue", "description": "Show the play queue as a poster wall" },
      ...
      "settings-toggle-lattice-vignette": { "title": "Toggle queue collage vignette", "description": "Turn the edge vignette on the queue collage on or off" },
  ...
  "home": {
    ...
    "lattice": "Open play queue",
    "latticeLabel": "Play queue",
    "latticeBack": "Back",
    "latticeSubtitle": "CURRENT PLAY QUEUE",
    "latticePlay": "PLAY",
    ...
    "latticeExplore": "DRAG TO EXPLORE",
    "latticeExploreHint": "SCROLL TO MOVE · ARROWS TO STEP · ESC TO CLOSE",
  ...
  "options": {
    ...
    "importGroupLattice": "Queue collage",
