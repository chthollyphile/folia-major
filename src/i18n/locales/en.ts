...
export default {
  ...
  "options": {
    ...
    "enableHomeDynamicBackground": "Enable Home Dynamic Background",
    "enableHomeDynamicBackgroundDesc": "Keep background animation running on the home page instead of freezing it after leaving the player page.",
    "enableHomeDynamicBackgroundWarning": "This can severely increase GPU usage and is off by default.",
