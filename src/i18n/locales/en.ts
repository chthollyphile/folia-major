...
export default {
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "lattice-focus-current": { "title": "Focus current song", "description": "Center the playing song on the wall" },
      "navigate-lattice": { "title": "Go song wall", "description": "Show the play queue as a poster wall" },
  ...
  "home": {
    ...
    "lattice": "Open song wall",
    "latticeLabel": "Song wall",
    "latticeBack": "Back",
    "latticeSubtitle": "CURRENT PLAY QUEUE",
    "latticePosterCount": "{{count}} POSTERS",
    "latticePlay": "PLAY",
    "latticePanel": "Wall controls",
    "latticePanelClose": "Close wall controls",
