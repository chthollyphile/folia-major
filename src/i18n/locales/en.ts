...
export default {
  "notifications": {
    ...
    "closeToTray": "Closing the window will hide to tray",
    ...
    "autoplayOnLaunchOn": "Playback will start automatically on launch",
    "autoplayOnLaunchOff": "Playback will not start automatically on launch",
    "rememberPlaybackPositionOn": "The last playback position will be remembered",
    "rememberPlaybackPositionOff": "The last playback position will not be remembered",
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "desktop-toggle-close-to-tray": { "title": "Close to tray", "description": "Toggle hiding to the tray instead of quitting on close" },
      "desktop-toggle-launch-at-login": { "title": "Launch at login", "description": "Toggle starting Folia automatically after you sign in" },
      "playback-toggle-autoplay-on-launch": { "title": "Autoplay on launch", "description": "Toggle starting playback automatically when the app opens" },
      "playback-toggle-remember-position": { "title": "Remember playback position", "description": "Toggle resuming the last playback position on launch" },
      ...
      "playback-loop": { "title": "Toggle play mode", "description": "Cycle sequential, repeat all, repeat one and shuffle" },
  ...
  "options": {
    ...
    "desktopTrayBehaviorDesc": "Desktop only. Control minimize-to-tray, close-to-tray, and whether launch opens directly on the player page.",
    "minimizeToTray": "Minimize to tray",
    "minimizeToTrayDesc": "Hide the app to the system tray when you click minimize.",
    "closeToTray": "Close to tray",
    "closeToTrayDesc": "Hide the app to the system tray instead of quitting when you click the close button. Reopen it from the tray icon.",
    "launchAtLogin": "Launch at login",
    "launchAtLoginDesc": "Start Folia automatically after you sign in. Pairs well with close-to-tray to keep the app resident in the tray.",
    "launchAtLoginUnsupported": "This platform cannot configure launch at login automatically. Create an autostart entry manually.",
    "launchPlaybackSettings": "Launch playback behavior",
    "autoplayOnLaunch": "Autoplay on launch",
    "autoplayOnLaunchDesc": "Start playing as soon as the previous session is restored. If the browser blocks autoplay, you will be prompted to click once.",
    "rememberPlaybackPosition": "Remember last playback position",
    "rememberPlaybackPositionDesc": "Record the current track position and resume from it on next launch when the same track is restored. Positions near the start or end are not recorded.",
