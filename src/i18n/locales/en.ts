...
export default {
  ...
  "lyricFilter": {
    ...
    "regexDescription": "Match each line of the lyrics text against the pattern and remove matched lines. Multiple lines are allowed, each an independent rule.",
    "inputPlaceholder": "One regex per line, multiple lines allowed",
    "example": "Example:",
  ...
  "lyricStaff": {
    ...
    "customPatternDesc": "Leave empty to use the built-in credit dictionary. A custom pattern replaces it, one rule per line, and still only applies to the opening block.",
    "customPatternPlaceholder": "Leave empty for the built-in dictionary; one regex per line, multiple lines allowed",
