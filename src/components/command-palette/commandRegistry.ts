...
export const COMMAND_PALETTE_COMMANDS: CommandPaletteCommand[] = [
    ...
    createSettingsCommand('settings-mobile-ai', 'Mobile AI settings', 'Open mobile OpenAI-compatible settings', ['mobile ai', 'openai', 'api key', '移动端AI', '手机AI', '密钥', 'yidongduan', 'shouji', 'miyao', 'yd', 'sj', 'my'], 'options', 'mobileAi'),
